...
file=open("C:\\Users\pc\Documents\HomeWork1CLA\people.txt") 
people= file.read()
print(people)
###############################################################
#2- add a list of names to the file
people= people + "\nkarim don" +"\nmanel rahim"+"\nsihem ouagued"
file=open("C:\\Users\pc\Documents\HomeWork1CLA\people.txt",'w')
file.write(people)
################################################################
...
file=open("C:\\Users\pc\Documents\HomeWork1CLA\people.txt",'r')

with open("C:\\Users\pc\Documents\HomeWork1CLA\people.txt") as myfile:
